package pb2_re13_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      public function create_player(mcc:MovieClip) : void
      {
         ...
         mcc.hp_head = new Number(mcc.hea * 0.9);
         mcc.hp_body = new Number(mcc.hea * 1.2);
         mcc.hp_legs = new Number(mcc.hea * 0.9);
         mcc.hp_arms = new Number(mcc.hea * 0.8);
      ...
      public function LoadMap() : void
      {
         ...
         for each(bookInfo in xml.children())
         {
            ...
            if(a == "box")
            {
               ...
               this.mc = this.game.addChildAt(new block(),this.game.numChildren);
               this.mc.x = this.boxx[this.boxestotal];
               this.mc.y = this.boxy[this.boxestotal];
               this.mc.scaleX = this.boxw[this.boxestotal] / 100;
               this.mc.scaleY = this.boxh[this.boxestotal] / 100;
               ++this.boxestotal;
            }
            if(a == "water")
            {
            ...
            if(a == "player" || a == "enemy")
            {
               ...
               this.mc.x = new Number(b["#x"]);
               this.mc.y = new Number(b["#y"]);
               this.create_player(this.mc);
               this.mc.tox = new Number(b["#tox"]);
               this.mc.toy = new Number(b["#toy"]);
               if(a == "player")
               {
                  this.mc.hea *= new Number(b["#hea"]) / new Number(b["#hmax"]);
               }
               else
               {
                  this.mc.hea = new Number(b["#hea"]);
                  this.mc.hmax = new Number(b["#hmax"]);
               }
               this.mc.team = new Number(b["#team"]);
               this.mc.side = new Number(b["#side"]);
               this.mc.armored = new Number(b["#armored"]);
               this.mc.blood_red = new Number(b["#blood_red"]);
               this.mc.blood_green = new Number(b["#blood_green"]);
               this.mc.blood_blue = new Number(b["#blood_blue"]);
            }
         }
      }
                  ...
                  switch(this.triggers[a].actions_type[this.tr])
                  {
                     ...
                     case 12:
                        for(this.tr2 = 0; this.tr2 < this.playerstotal; ++this.tr2)
                        {
                           ...
                           {
                              if(this.vehicles[this.tr2].x > this.regions[this.triggers[a].actions_targetB[this.tr]].x)
                              {
                                 if(this.vehicles[this.tr2].x < this.regions[this.triggers[a].actions_targetB[this.tr]].x + this.regions[this.triggers[a].actions_targetB[this.tr]].w)
                                 {
                                    if(this.vehicles[this.tr2].y > this.regions[this.triggers[a].actions_targetB[this.tr]].y)
                                    {
                                       if(this.vehicles[this.tr2].y < this.regions[this.triggers[a].actions_targetB[this.tr]].y + this.regions[this.triggers[a].actions_targetB[this.tr]].h)
                                       {
                     ...
                     case 23:
                        ...
                        break;
                     case 24:
                        this.PhysicsExplosion(this.regions[this.triggers[a].actions_targetB[this.tr]].x + this.regions[this.triggers[a].actions_targetB[this.tr]].w / 2,this.regions[this.triggers[a].actions_targetB[this.tr]].y + this.regions[this.triggers[a].actions_targetB[this.tr]].h / 2,this.triggers[a].actions_targetA[this.tr] * 5,this.triggers[a].actions_targetB[this.tr] / 4,this.triggers[a].actions_targetB[this.tr],-1);
                        break;
                  }
               }
      ...
      public function create_barrel(mcc:MovieClip) : void
      {
         ...
         mcc.hea = 25;
         mcc.dist = 130;
         mcc.b_left_top = this.CreatePoint(mcc.x - 5,mcc.y - 13,mcc.tox,mcc.toy,5,false,3,-this.barrelstotal - 100);
         mcc.b_right_top = this.CreatePoint(mcc.x + 5,mcc.y - 13,mcc.tox,mcc.toy,5,false,3,-this.barrelstotal - 100);
         mcc.b_right_bottom = this.CreatePoint(mcc.x + 5,mcc.y + 13,mcc.tox,mcc.toy,5,false,3,-this.barrelstotal - 100);
         mcc.b_left_bottom = this.CreatePoint(mcc.x - 5,mcc.y + 13,mcc.tox,mcc.toy,5,false,3,-this.barrelstotal - 100);
      ...
      public function create_vehicle(mcc:MovieClip, n:Number, side:Number) : void
      {
         ...
         if(n == 1)
         {
            ...
            for(this.i = 0; this.i < 2; ++this.i)
            {
               ...
               mcc.ch_cross = this.Connect(mcc.b_w1,mcc.b_w2,2,200,1);
            }
      ...
      public function HurtMyPlayer(xx:Number, yy:Number, power:Number) : void
      {
         ...
         {
            this._root["pb" + this.i4].alpha += power * 0.025;
      ...
      {
         for(this.i4 = 0; this.i4 < this.boxestotal + this.doorstotal; ++this.i4)
         {
            for(this.i3 = 0; this.i3 < 4; ++this.i3)
            {
               if(this.i4 < this.boxestotal)
               {
                  if(this.i3 == 0)
                  {
               ...
               {
                  this.x3 = this.doors[this.i4 - this.boxestotal].x;
                  this.y3 = this.doors[this.i4 - this.boxestotal].y;
                  this.x4 = this.doors[this.i4 - this.boxestotal].x + this.doors[this.i4 - this.boxestotal].w;
                  this.y4 = this.doors[this.i4 - this.boxestotal].y;
               }
               else if(this.i3 == 1)
               {
                  this.x3 = this.doors[this.i4 - this.boxestotal].x + this.doors[this.i4 - this.boxestotal].w;
                  this.y3 = this.doors[this.i4 - this.boxestotal].y;
                  this.x4 = this.doors[this.i4 - this.boxestotal].x + this.doors[this.i4 - this.boxestotal].w;
                  this.y4 = this.doors[this.i4 - this.boxestotal].y + this.doors[this.i4 - this.boxestotal].h;
               }
               else if(this.i3 == 2)
               {
                  this.x3 = this.doors[this.i4 - this.boxestotal].x;
                  this.y3 = this.doors[this.i4 - this.boxestotal].y;
                  this.x4 = this.doors[this.i4 - this.boxestotal].x;
                  this.y4 = this.doors[this.i4 - this.boxestotal].y + this.doors[this.i4 - this.boxestotal].h;
               }
               else if(this.i3 == 3)
               {
                  this.x3 = this.doors[this.i4 - this.boxestotal].x;
                  this.y3 = this.doors[this.i4 - this.boxestotal].y + this.doors[this.i4 - this.boxestotal].h;
                  this.x4 = this.doors[this.i4 - this.boxestotal].x + this.doors[this.i4 - this.boxestotal].w;
                  this.y4 = this.doors[this.i4 - this.boxestotal].y + this.doors[this.i4 - this.boxestotal].h;
               }
                  ...
                  if(Math.max(xx2,xx) + 1 >= this.retux)
                  {
                     if(Math.min(yy2,yy) - 1 <= this.retuy)
                     {
                        if(Math.max(yy2,yy) + 1 >= this.retuy)
                        {
                           ...
                           else if(this.doors[this.i4 - this.boxestotal].x - 1 <= this.retux)
                           {
                              if(this.doors[this.i4 - this.boxestotal].x + 1 + this.doors[this.i4 - this.boxestotal].w >= this.retux)
                              {
                                 if(this.doors[this.i4 - this.boxestotal].y - 1 <= this.retuy)
                                 {
                                    if(this.doors[this.i4 - this.boxestotal].y + 1 + this.doors[this.i4 - this.boxestotal].h >= this.retuy)
                                    {
                                       return false;
                                    }
                                 }
         ...
         if(this.system_non_stop)
         {
                                 ...
                                 if(this.mens[this.i2].incar == -1)
                                 {
                                    ...
                                    if(this.i3 != -1)
                                    {
                                       ...
                                       if(this.str == "body")
                                       {
                                          ...
                                          this.ablood[this.mc2.b_body] += this.puls[this.i].power * 5;
                                       }
                                       else if(this.str == "head")
                                       {
                                          ...
                                          this.ablood[this.mc2.b_head_start] += this.puls[this.i].power * 5;
                                       }
                                       else if(this.str == "legs")
                                       {
                                          ...
                                          if(Math.random() > 0.5)
                                          {
                                             this.ablood[this.mc2.b_leg1] += this.puls[this.i].power * 5;
                                          }
                                          else
                                          {
                                             this.ablood[this.mc2.b_leg2] += this.puls[this.i].power * 5;
                                          }
                                       }
                                       else if(this.str == "arms")
                                       {
                                          ...
                                          if(Math.random() > 0.5)
                                          {
                                             this.ablood[this.mc2.b_arm1] += this.puls[this.i].power * 5;
                                          }
                                          else
                                          {
                                             this.ablood[this.mc2.b_arm2] += this.puls[this.i].power * 5;
                                          }
                                       }
                                       if(this.i2 == 0)
                                       {
               ...
               if(this.mens[this.i].hea > 0 && this.mens[this.i].x > -this.game.x / this.game_scale - this.screenX / this.game_scale && this.mens[this.i].x < -this.game.x / this.game_scale + this.screenX * 2 / this.game_scale && this.mens[this.i].y > -this.game.y / this.game_scale - this.screenY / this.game_scale && this.mens[this.i].y < -this.game.y / this.game_scale + this.screenY * 2 / this.game_scale || this.mens[this.i].hea <= 0 && this.mens[this.i].x + this.mens[this.i].body.x > -this.game.x / this.game_scale - 200 && this.mens[this.i].x + this.mens[this.i].body.x < -this.game.x / this.game_scale + this.screenX / this.game_scale + 200 && this.mens[this.i].y + this.mens[this.i].body.y > -this.game.y / this.game_scale - 200 && this.mens[this.i].y + this.mens[this.i].body.y < -this.game.y / this.game_scale + this.screenY / this.game_scale + 200)
               {
                           ...
                           if(this.mc.x > this.regions[this.i2].x)
                           {
                              if(this.mc.x < this.regions[this.i2].x + this.regions[this.i2].w)
                              {
                                 if(this.mc.y - 41 > this.regions[this.i2].y)
                                 {
                                    ...
                                    {
                                       if(this.regions[this.i2].use_on == 1 && this.i == 0 && this.key_pick && this.mc.incar == -1 || this.regions[this.i2].use_on == 2 && this.mc.incar == -1 || this.regions[this.i2].use_on == 3 && this.mc.incar != -1 || this.regions[this.i2].use_on == 4)
                                       {
                  ...
                  else if(this.mc.hea > 0)
                  {
                     ...
                     if(this.mc.hunt != -1)
                     {
                        ...
                        for(this.i2 = 0; this.i2 < this.barrelstotal; ++this.i2)
                        {
                           this.xx2 = this.Dist2D(this.mc.tarx,this.mc.tary,this.barrels[this.i2].x,this.barrels[this.i2].y);
                           this.yy2 = this.Dist2D(this.mc.x,this.mc.y,this.barrels[this.i2].x,this.barrels[this.i2].y);
            ...
            for(this.i = 0; this.i < this.vehiclestotal; ++this.i)
            {
               ...
               if(this.mc.typ == 0)
               {
                  ...
                  else if(this.mc.master != -1)
                  {
                     ...
                     {
                        if(this.acollided[this.mc.b_w1] == 1 || this.aio[this.mc.b_w1] == false)
                        {
                        ...
                        if(this.acollided[this.mc.b_w2] == 1 || this.aio[this.mc.b_w2] == false)
                        {
               ...
               if(this.mc.typ == 1)
               {
                  ...
                  else if(this.mc.master != -1)
                  {
                     ...
                     if(this.mc2.act_movex != 0)
                     {
                        ...
                        if(Boolean(this.acollided[this.mc.b_w1]) || Boolean(this.acollided[this.mc.b_w2]))
                        {
                           this.atox[this.mc.b_p1] += this.mc2.act_movex;
                        }
            ...
            if(this.playerstotal > 0)
            {
               ...
               if(this.mens[0].hea > 0)
               {
                  if(this.pb4.alpha > 0)
                  {
                     this.game.x += (Math.round(Math.random() * 20) - 10) * this.pb4.alpha;
                     this.game.y += (Math.round(Math.random() * 20) - 10) * this.pb4.alpha;
                  }
               }
            }
         }
            ...
            if(this.ax[this.i] > -this.game.x / this.game_scale - this.screenX / this.game_scale && this.ax[this.i] < -this.game.x / this.game_scale + this.screenX * 2 / this.game_scale && this.ay[this.i] > -this.game.y / this.game_scale - this.screenY / this.game_scale && this.ay[this.i] < -this.game.y / this.game_scale + this.screenY * 2 / this.game_scale)
            {
               ...
               if(this.aio[this.i] == true)
               {
                  ...
                  if(this.aof[this.i] >= 0 && this.mens[this.aof[this.i]].incar == -1)
                  {
                     ...
                     {
                        if(this.ablood[this.i] > 30)
                        {
                           this.ablood[this.i] = 30;
                        }
                        else
                        {
                           this.ablood[this.i] -= 0.1;
                        }
                        if(Math.random() > 0.8)
                        {
                           ...
                           if(this.ax[this.i] <= this.xx2 + this.arad[this.i] + this.x3)
                           {
                              if(this.ay[this.i] >= this.yy2 - this.arad[this.i] - 1)
                              {
                                 if(this.ay[this.i] <= this.yy2 + this.arad[this.i] + this.y3)
                                 {
                                    ...
                                    else if(this.amat[this.i] == 5 || this.amat[this.i] == 6)
                                    {
                                       if(this.acollided[this.i] == 0)
                                       {
                                          this.acollided[this.i] = 1;
                                          ...
                                          else if(this.yy > 3)
                                          {
                                             ...
                                             else if(this.yy > 6 && this.atoy[this.i] > 0)
                                             {
      ...
      internal function frame1() : *
      {
         ...
         this.menu_start.addEventListener(MouseEvent.MOUSE_DOWN,function():*
         {
            if(txt.text == "")
            {
               MovieClip(root).mapdata = "<box x=\"-410\" y=\"-100\" w=\"580\" h=\"100\" enabled=\"true\" /><box x=\"-550\" y=\"-300\" w=\"300\" h=\"250\" enabled=\"true\" /><player x=\"100\" y=\"-681\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"0\" side=\"1\" armored=\"1\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><box x=\"-50\" y=\"-200\" w=\"550\" h=\"600\" enabled=\"true\" /><box x=\"50\" y=\"-300\" w=\"250\" h=\"200\" enabled=\"true\" /><barrel x=\"0\" y=\"-238\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><barrel x=\"30\" y=\"-238\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><door x=\"110\" y=\"-400\" w=\"30\" h=\"100\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><box x=\"50\" y=\"-600\" w=\"110\" h=\"200\" enabled=\"true\" /><enemy x=\"280\" y=\"-381\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"1\" side=\"1\" armored=\"0\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><gun x=\"-140\" y=\"-117\" model=\"gun_rifle\" command=\"-1\" /><gun x=\"280\" y=\"-347\" model=\"gun_apistol\" command=\"1\" /><region x=\"80\" y=\"-400\" w=\"30\" h=\"100\" use_target=\"0\" use_on=\"4\" /><region x=\"110\" y=\"-500\" w=\"30\" h=\"100\" use_target=\"-1\" use_on=\"4\" /><trigger x=\"170\" y=\"-365\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"0\" actions_1_targetA=\"0\" actions_1_targetB=\"1\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><box x=\"-550\" y=\"-350\" w=\"260\" h=\"90\" enabled=\"true\" /><box x=\"1100\" y=\"-510\" w=\"150\" h=\"210\" enabled=\"true\" /><box x=\"-600\" y=\"-900\" w=\"110\" h=\"690\" enabled=\"true\" /><box x=\"-300\" y=\"-630\" w=\"370\" h=\"180\" enabled=\"true\" /><water x=\"-250\" y=\"-190\" w=\"200\" h=\"120\" damage=\"0\" /><box x=\"900\" y=\"-200\" w=\"350\" h=\"600\" enabled=\"true\" /><box x=\"300\" y=\"300\" w=\"800\" h=\"200\" enabled=\"true\" /><water x=\"500\" y=\"210\" w=\"400\" h=\"120\" damage=\"5\" /><door x=\"310\" y=\"-190\" w=\"200\" h=\"40\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><door x=\"890\" y=\"-190\" w=\"200\" h=\"40\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><region x=\"500\" y=\"-190\" w=\"200\" h=\"40\" use_target=\"-1\" use_on=\"4\" /><region x=\"700\" y=\"-190\" w=\"200\" h=\"40\" use_target=\"-1\" use_on=\"4\" /><region x=\"400\" y=\"-300\" w=\"100\" h=\"100\" use_target=\"1\" use_on=\"1\" /><trigger x=\"700\" y=\"-235\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"0\" actions_1_targetA=\"1\" actions_1_targetB=\"2\" actions_2_type=\"0\" actions_2_targetA=\"2\" actions_2_targetB=\"3\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><box x=\"90\" y=\"-600\" w=\"1410\" h=\"170\" enabled=\"true\" /><enemy x=\"920\" y=\"-281\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"1\" side=\"1\" armored=\"0\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><gun x=\"910\" y=\"-247\" model=\"gun_arifle\" command=\"-1\" /><gun x=\"-200\" y=\"-117\" model=\"gun_pistol\" command=\"-1\" /><door x=\"1160\" y=\"-300\" w=\"30\" h=\"100\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><region x=\"1130\" y=\"-300\" w=\"30\" h=\"100\" use_target=\"2\" use_on=\"4\" /><region x=\"1160\" y=\"-400\" w=\"30\" h=\"100\" use_target=\"-1\" use_on=\"4\" /><trigger x=\"1280\" y=\"-245\" enabled=\"true\" maxcalls=\"-1\" actions_1_type=\"0\" actions_1_targetA=\"3\" actions_1_targetB=\"6\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><box x=\"1150\" y=\"-550\" w=\"1020\" h=\"230\" enabled=\"true\" /><box x=\"1100\" y=\"-150\" w=\"700\" h=\"350\" enabled=\"true\" /><enemy x=\"1010\" y=\"-281\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"1\" side=\"1\" armored=\"0\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><gun x=\"1000\" y=\"-247\" model=\"gun_arifle\" command=\"-1\" /><enemy x=\"1400\" y=\"-231\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"1\" side=\"1\" armored=\"0\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><gun x=\"1390\" y=\"-197\" model=\"gun_arifle\" command=\"-1\" /><barrel x=\"1310\" y=\"-188\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><barrel x=\"350\" y=\"-238\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><region x=\"1190\" y=\"-300\" w=\"30\" h=\"100\" use_target=\"2\" use_on=\"4\" /><region x=\"1220\" y=\"-300\" w=\"30\" h=\"100\" use_target=\"3\" use_on=\"4\" /><region x=\"1100\" y=\"-300\" w=\"30\" h=\"100\" use_target=\"3\" use_on=\"4\" /><trigger x=\"1280\" y=\"-285\" enabled=\"true\" maxcalls=\"-1\" actions_1_type=\"0\" actions_1_targetA=\"3\" actions_1_targetB=\"10\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><region x=\"1160\" y=\"-300\" w=\"30\" h=\"100\" use_target=\"-1\" use_on=\"4\" /><barrel x=\"-390\" y=\"-388\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><barrel x=\"-360\" y=\"-388\" model=\"bar_orange\" tox=\"0\" toy=\"0\" /><box x=\"1600\" y=\"0\" w=\"850\" h=\"280\" enabled=\"true\" /><vehicle x=\"1930\" y=\"-140\" side=\"1\" model=\"veh_jeep\" tox=\"0\" toy=\"0\" /><box x=\"2400\" y=\"140\" w=\"800\" h=\"140\" enabled=\"true\" /><box x=\"2750\" y=\"-400\" w=\"150\" h=\"400\" enabled=\"true\" /><box x=\"3140\" y=\"-200\" w=\"1030\" h=\"480\" enabled=\"true\" /><door x=\"2900\" y=\"140\" w=\"240\" h=\"480\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><region x=\"2900\" y=\"-200\" w=\"240\" h=\"480\" use_target=\"5\" use_on=\"3\" /><trigger x=\"3020\" y=\"-235\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"0\" actions_1_targetA=\"4\" actions_1_targetB=\"11\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><door x=\"2750\" y=\"140\" w=\"40\" h=\"140\" moving=\"false\" tarx=\"0\" tary=\"0\" maxspeed=\"5\" /><region x=\"2750\" y=\"0\" w=\"40\" h=\"140\" use_target=\"6\" use_on=\"5\" /><region x=\"2860\" y=\"0\" w=\"40\" h=\"140\" use_target=\"4\" use_on=\"5\" /><trigger x=\"2730\" y=\"65\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"0\" actions_1_targetA=\"5\" actions_1_targetB=\"12\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><trigger x=\"2840\" y=\"65\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"0\" actions_1_targetA=\"5\" actions_1_targetB=\"13\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" /><box x=\"4100\" y=\"-370\" w=\"70\" h=\"170\" enabled=\"true\" /><vehicle x=\"270\" y=\"-840\" side=\"1\" model=\"veh_walker\" tox=\"0\" toy=\"0\" /><box x=\"600\" y=\"-620\" w=\"150\" h=\"140\" enabled=\"true\" /><box x=\"1050\" y=\"-670\" w=\"150\" h=\"140\" enabled=\"true\" /><box x=\"2000\" y=\"-800\" w=\"150\" h=\"310\" enabled=\"true\" /><gun x=\"40\" y=\"-647\" model=\"gun_rl\" command=\"-1\" /><gun x=\"-40\" y=\"-647\" model=\"gun_gl\" command=\"-1\" /><gun x=\"270\" y=\"-857\" model=\"gun_vehcannon\" command=\"-1\" /><gun x=\"1940\" y=\"-157\" model=\"gun_vehgun\" command=\"-1\" /><vehicle x=\"890\" y=\"-830\" side=\"-1\" model=\"veh_walker\" tox=\"0\" toy=\"0\" /><gun x=\"890\" y=\"-847\" model=\"gun_vehcannon\" command=\"-1\" /><enemy x=\"760\" y=\"-701\" tox=\"0\" toy=\"0\" hea=\"100\" hmax=\"100\" team=\"1\" side=\"1\" armored=\"0\" blood_red=\"1\" blood_green=\"0\" blood_blue=\"0\" /><region x=\"120\" y=\"-940\" w=\"350\" h=\"340\" use_target=\"7\" use_on=\"3\" /><trigger x=\"560\" y=\"-955\" enabled=\"true\" maxcalls=\"1\" actions_1_type=\"13\" actions_1_targetA=\"5\" actions_1_targetB=\"2\" actions_2_type=\"-1\" actions_2_targetA=\"0\" actions_2_targetB=\"0\" actions_3_type=\"-1\" actions_3_targetA=\"0\" actions_3_targetB=\"0\" actions_4_type=\"-1\" actions_4_targetA=\"0\" actions_4_targetB=\"0\" actions_5_type=\"-1\" actions_5_targetA=\"0\" actions_5_targetB=\"0\" actions_6_type=\"-1\" actions_6_targetA=\"0\" actions_6_targetB=\"0\" actions_7_type=\"-1\" actions_7_targetA=\"0\" actions_7_targetB=\"0\" actions_8_type=\"-1\" actions_8_targetA=\"0\" actions_8_targetB=\"0\" actions_9_type=\"-1\" actions_9_targetA=\"0\" actions_9_targetB=\"0\" actions_10_type=\"-1\" actions_10_targetA=\"0\" actions_10_targetB=\"0\" />";
            }
            else
            {
